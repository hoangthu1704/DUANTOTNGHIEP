                                        ...
                                        <form method="post" action="{{ route('user.profile.store') }}" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input required class="form-control" name="username" type="text" value="{{ old('username', 'user') }}">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label>Full Name <span class="required">*</span></label>
                                                    <input required class="form-control" name="name" value="{{ old('name', 'User') }}">
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <label>Email <span class="required">*</span></label>
                                                    <input required class="form-control" name="email" type="email" value="{{ old('email', 'user@gmail.com') }}">
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <label>Phone <span class="required">*</span></label>
                                                    <input required class="form-control" name="phone" type="text" value="{{ old('phone', '4343434111') }}">
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <label>Address <span class="required">*</span></label>
                                                    <input required class="form-control" name="address" type="text" value="{{ old('address', 'usa') }}">
                                                </div>
                                                <div class="form-group col-md-12">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <img id="showImage" src="{{ asset('upload/user_images/202207242133images (1).png') }}" alt="User" class="rounded-circle p-1 bg-primary" width="110">
                                                </div>
                                                <div class="col-md-12">
