							...
							<div class="border border-3 p-4 rounded">
								<div class="row g-3">
									...
									<div class="col-md-6">
										...
										<input type="text" name="discount_price" value="" class="form-control" id="inputCompareatprice" placeholder="00.00">
									</div>
									<div class="form-group col-md-6">
										<label for="inputCostPerPrice" class="form-label">Product Code <span class="text-danger">*</span></label>
										<input type="text" name="product_code" value="" class="form-control" id="inputCostPerPrice" placeholder="00.00">
									</div>
									<div class="form-group col-md-6">
...
<script src="http://127.0.0.1:8000/adminbackend/plugins_rich_text/js/pages/add-product.init.js"></script>
...
<script type="text/javascript">
	...
	function renderFrameInputVariant(sothutu, valueinput) {
		...
		script.src = "http://127.0.0.1:8000/adminbackend/assets/plugins/input-tags/js/tagsinput.js";
